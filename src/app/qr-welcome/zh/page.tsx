...
const products = [
  {
    id: "tika",
    tag: "TİKA",
    title: "TİKA — 远程控制模块化平台",
    desc: "适用于农业、市政、冬季作业及应急响应的属具。",
    href: "/zh/products/tika",
    img: "/galeri/tika_qr.png",
  },
  {
    id: "mini-tika",
    tag: "Mini-TİKA",
    title: "Mini-TİKA — 紧凑型无人地面车辆 (UGV)",
    desc: "轻便灵活，专为狭窄空间设计。",
    href: "/zh/products/mini-tika",
  ...
  },
  {
    ...
    title: "履带式动力系统",
    desc: "与复杂地形兼容的模块化结构。",
    href: "/zh/products/track-systems",
...
export default function QRWelcomeDetailZH() {
  ...
  const openBadge = useMemo(() => {
    return isOpen
      ? { text: "正在营业", cls: "bg-emerald-500/10 text-emerald-700 ring-1 ring-emerald-500/15" }
      : { text: "已休息", cls: "bg-rose-500/10 text-rose-700 ring-1 ring-rose-500/15" };
  }, [isOpen]);
          ...
          <div className="relative p-7">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-[12px] font-black uppercase tracking-[0.2em]">致电</span>
          ...
          <div className="rounded-[26px] bg-white/65 backdrop-blur-xl ring-1 ring-black/5 shadow-sm p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[10px] text-slate-500 italic">周一至周五</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-[11px] text-slate-500">点击复制</p>
              </div>
            </div>
          </button>
        </div>
            ...
            >
              <div className="relative h-60">
                ...
                <div className="absolute left-6 bottom-6">
                  ...
                  <p className="text-white text-[20px] font-black tracking-tight">查看图库</p>
                ...
                <div className="absolute inset-0 grid place-items-center">
                  <div className="flex items-center gap-3 rounded-full bg-white/15 px-5 py-3 backdrop-blur-md ring-1 ring-white/20 transition group-hover:scale-[1.03]">
                    ...
                    <div>
                      ...
                      <p className="text-white/70 text-[11px] font-semibold">观看视频</p>
                    </div>
                  </div>
                </div>

                <div className="absolute left-6 bottom-6">
                  <p className="text-white text-[20px] font-black tracking-tight">视频展示</p>
                  <p className="mt-1 text-white/70 text-[11px] font-bold tracking-[0.25em] uppercase">
                    @temrenmakina
                  </p>
                </div>
