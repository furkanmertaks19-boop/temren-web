...
const products = [
  {
    id: "tika",
    tag: "TİKA",
    title: "TİKA — Uzaktan Kumandalı Modüler Platform",
    desc: "Tarım, belediye, kış ve acil durum ataşmanları.",
    href: "/urunler/tika",
  ...
  },
  {
    id: "mini-tika",
    tag: "Mini-TİKA",
    title: "Mini-TİKA — Kompakt UGV",
    desc: "Dar alanlara uygun, hafif ve çevik.",
  ...
  },
  {
    ...
    desc: "Zorlu araziye uyumlu, modüler yapı.",
...
export default function QRWelcomeDetail({ params }: { params: { lang: string } }) {
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title: "Temren Makina",
          text: "Temren Makina • Hızlı İletişim & Ürünler",
          url,
        });
        return;
      }
  ...
  const openBadge = useMemo(() => {
    return isOpen
      ? { text: "Şu an açık", cls: "bg-emerald-500/10 text-emerald-700 ring-1 ring-emerald-500/15" }
      : { text: "Şu an kapalı", cls: "bg-rose-500/10 text-rose-700 ring-1 ring-rose-500/15" };
  }, [isOpen]);
          ...
          <div className="relative p-7">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-[12px] font-black uppercase tracking-[0.2em]">Ara</span>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-[11px] text-slate-500">Kopyalamak için dokunun</p>
              </div>
            </div>
          </button>
        </div>
            ...
            >
              <div className="relative h-60">
                ...
                <div className="absolute left-6 bottom-6">
                  ...
                  <p className="text-white text-[20px] font-black tracking-tight">Görüntüle</p>
