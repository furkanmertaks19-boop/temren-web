...
import {
    ...
    Zap, Gauge, Settings, X, Layers, Loader2, Camera, Maximize2, Send, User, Phone, Mail, MessageSquare, Droplets, FlaskConical
} from 'lucide-react';
import Footer from "@/components/layout/Footer";

export default function BYK1000Page() {
    ...
    const mainImage = "/image/byk1000.jpg";
    const gallery = ["/image/byk1000_1.webp", "/image/byk1000_2.webp", "/image/byk1000.jpg"];
        ...
        <main className="bg-[#050505] min-h-screen relative text-white selection:bg-amber-500 selection:text-black font-sans overflow-x-hidden">
            ...
            <div className="fixed inset-0 w-full h-screen z-0">
                <motion.div style={{ scale }} className="relative w-full h-full">
                    <Image src={mainImage} alt="BYK-1000" fill className="object-cover opacity-40" priority />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#050505] via-transparent to-[#050505]/80" />
                </motion.div>
            </div>
{/* ✅ SEO: BYK1000 - Product + Breadcrumb + FAQ */}
<script
    ...
    __html: JSON.stringify([
      // 1) Breadcrumb
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 4, "name": "BYK1000", "item": "https://temrenmakina.com/urunler/uretim/byk1000" }
        ]
      },
      ...
      // 2) Product
      {
        ...
        "name": "BYK1000",
        "image": [
          "https://temrenmakina.com/og/byk1000.jpg"
        ],
        "description": "BYK1000; üretim süreçleri için tasarlanmış, dayanıklı ve verimli endüstriyel çözüm.",
        "brand": { "@type": "Brand", "name": "Temren Makina" },
        "category": "Üretim Ekipmanları",
        "url": "https://temrenmakina.com/urunler/uretim/byk1000"
      },
      ...
      // 3) FAQ
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "İmalat/üretim hatları ve endüstriyel süreçlerde, uygulamaya göre farklı senaryolarda kullanılabilir."
            }
          },
          {
            "@type": "Question",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Sayfadaki teklif formundan veya iletişim sayfası üzerinden BYK1000 için teklif talep edebilirsiniz."
            }
          }
        ]
      }
            ...
            <div className="relative z-10 w-full">
                ...
                <section className="h-screen flex flex-col items-center justify-center text-center px-6">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}>
                        ...
                        <h1 className="text-7xl md:text-[14rem] font-black tracking-tighter leading-[0.75] mb-8 uppercase italic drop-shadow-2xl">
                            BYK <span className="text-amber-500">1000</span>
                        </h1>
                        <p className="text-white/80 text-xl md:text-3xl max-w-4xl mx-auto font-black leading-relaxed italic tracking-tight px-6 uppercase text-center">
                            Stabil Karışım Performansı: Endüstriyel Bor Yağı Emülsiyonu Hazırlama Çözümü.
                        </p>

                        <div className="flex flex-wrap justify-center gap-4 mt-12">
                            {["STABİL KARIŞIM", "KADEMELİ AYAR", "KOLAY MONTAJ"].map((chip, i) => (
                ...
                {/* 2. AVANTAJLAR */}
                <section className="py-32 px-6 container mx-auto text-left md:text-left">
                    <div className="mb-24 text-center">
                        <h2 className="text-6xl md:text-[10rem] font-black uppercase tracking-tighter mb-6 italic leading-none text-white text-center">KULLANIM <span className="text-amber-500 font-light italic">AVANTAJLARI</span></h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { icon: <ShieldCheck size={32} />, title: "DAYANIKLI YAPI", desc: "Endüstriyel kullanım için sağlam ve uzun ömürlü polimer/metal gövde tasarımı." },
                            { icon: <Droplets size={32} />, title: "STABİL KARIŞIM", desc: "Basınca duyarlı yapısı ile %1 - %10 arasında sabit oranlı karışım performansı." },
                            { icon: <Zap size={32} />, title: "HIZLI MONTAJ", desc: "Varil kapağına hızlı ve güvenli entegrasyon imkânı ile zaman tasarrufu sağlar." },
                            { icon: <Gauge size={32} />, title: "HASSAS AYAR", desc: "Emülsiyon yoğunluğu ayar vanası ile istenilen oranlarda kolayca ayarlanabilir." }
                        ].map((adv, i) => (
                ...
                <section className="py-32 px-6 container mx-auto max-w-4xl">
                    ...
                    <div className="grid grid-cols-1 gap-4 font-sans text-white">
                        {[
                            { l: "Yoğunluk Aralığı", v: "%1 – %10 Hassas Ayar" },
                            { l: "Uygulama Alanı", v: "Bor Yağı Emülsiyon Sistemleri" },
                            { l: "Bağlantı Tipi", v: "Şebeke Suyu & Hortumlu Çıkış" },
                            { l: "Ölçüm Kontrolü", v: "Refraktometre Uyumlu" }
                        ].map((item, i) => (
                ...
                <section className="py-32 px-6 container mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        {gallery.map((img, i) => (
                            ...
                            >
                                <Image src={img} alt="BYK-1000 Galeri" fill className="object-cover grayscale hover:grayscale-0 transition-all duration-1000" />
                ...
                <section className="py-44 text-center bg-white text-black rounded-t-[6rem] md:rounded-t-[10rem] relative overflow-hidden">
                    <div className="relative z-10 px-6 font-sans">
                        <h2 className="text-7xl md:text-[12rem] font-black uppercase tracking-tighter mb-20 leading-[0.8] italic text-slate-900 text-center uppercase">STABİL <br /> <span className="text-amber-500">AKIŞ.</span></h2>
                        <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-4xl mx-auto">
                            <a href="/dokumanlar/byk1000.pdf" target="_blank" className="flex-1 bg-slate-100 text-slate-900 px-12 py-8 rounded-full font-black text-xl hover:bg-slate-200 transition-all flex items-center justify-center gap-4 group italic border border-slate-200 uppercase tracking-widest leading-none">
                            ...
                            <div className="p-12 md:p-14 text-slate-900 font-sans">
                                {success ? (
                                    <div className="text-center py-10">
                                        ...
                                        <h2 className="text-4xl font-black italic uppercase tracking-tighter leading-tight text-slate-900">TALEBİNİZ <br /><span className="text-amber-500 font-light italic text-3xl">KAYDEDİLDİ</span></h2>
                                    </div>
                                ) : (
                                    <>
                                        ...
                                        <form onSubmit={handleFormSubmit} className="space-y-4">
                                            ...
                                            <div className="relative group text-slate-900">
                                                ...
                                                <textarea rows={2} placeholder="Sistem Notlarınız..." value={form.mesaj} onChange={(e) => setForm({ ...form, mesaj: e.target.value })} className="w-full bg-slate-50 border-2 border-slate-100 rounded-3xl pl-16 pr-8 py-6 text-slate-900 outline-none focus:bg-white focus:border-amber-500 transition-all font-black resize-none" />
                                            </div>
