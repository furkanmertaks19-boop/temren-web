...
// ✅ 1. Video Nesnesi İçin Tip Tanımlaması (Vercel Hatasını Çözer)
interface VideoItem {
  id: number;
  youtubeId?: string; // Opsiyonel yaptık çünkü her videoda olmayabilir
  title: string;
  desc: string;
  badge: string;
  category: string;
  type: "youtube" | "link"; // Sadece bu iki değerden biri olabilir
  url?: string; // Sayfa linki varsa buraya gelecek
}

// ✅ 2. Güncellenmiş Veri Seti (Her videoya 'type' eklendi)
const videos: VideoItem[] = [
  { id: 1, youtubeId: "6vlxv1Vr7Ug", title: "TARMAKBİS TİKA Röportajı", desc: "Uzaktan Kumandalı Modüler Paletli Araç Tanıtımı", badge: "TİKA", category: "PALET", type: "youtube" },
  { id: 2, youtubeId: "bekG6AthG44", title: "Erkunt Traktör ile Gerçek Arazi Testi", desc: "Gerçek arazi koşullarında test edildi, farkını ortaya koydu.", badge: "Palet", category: "PALET", type: "youtube" },
  { id: 3, youtubeId: "AofiHUGvVMU", title: "TİKA", desc: "Uzaktan Kumandalı Traktör ve Palet Sistemleri", badge: "TİKA", category: "PALET", type: "youtube" },
  { id: 4, youtubeId: "7VUhqXtfdBo", title: "Temren Makina Palet Sistemleri", desc: "Ayer Tohumculuk Palet Müşteri Deneyimi", badge: "Palet", category: "MÜŞTERİ", type: "youtube" },
  { id: 5, youtubeId: "6ZOyv3LSKbE", title: "Temren Makina Palet Sistemleri", desc: "Mutlular Tarım Palet Müşteri Deneyimi", badge: "Müşteri", category: "MÜŞTERİ", type: "youtube" },
  { id: 7, youtubeId: "qnnbb51zp4Q", title: "Doğan Kabak ile Test Sürüşü", desc: "Arazide yepyeni bir deneyim", badge: "Test", category: "PALET", type: "youtube" },
  { id: 8, youtubeId: "038aEHmegcc", title: "Araç Palet Sistemi", desc: "Arazide yepyeni bir deneyim", badge: "Arazide", category: "PALET", type: "youtube" },
  { id: 9, youtubeId: "lq20v0-Nhgo", title: "Doğru Tork ile Sıkma", desc: "Takım Sıkma Mekanizması", badge: "Üretim", category: "ÜRETİM", type: "youtube" },
  { id: 10, youtubeId: "lq20v0-Nhgo", title: "Maksimum Vakum Gücü", desc: "Elektronik kontrol paneli ile", badge: "Üretim", category: "ÜRETİM", type: "youtube" }
];
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-20">
            {categories.map((cat) => (
              <button
                ...
                className={`px-8 py-3 rounded-2xl text-[10px] font-black tracking-[0.2em] uppercase transition-all ${filter === cat
